...
PARAM_METADATA: Dict[str, Dict[str, Dict[str, Any]]] = {
    "steering": {
        ...
        "torque_low_speed_gain": param_meta(
            "저속 곡률 오차 이득", "기본 토크 제한", "배율", 0.05, 0.1, 1.0,
            "저속에서 곡률 오차를 증폭하는 openpilot 곡선에 곱하는 배율입니다. "
            "35 km/h 미만에서만 적용됩니다. "
            "20 km/h 아래에서는 이 항이 제어 오차의 95%를 만들어, 평범한 플랜·"
            "센서 노이즈가 포화 토크가 됩니다.",
            "저속 차선 유지가 단단해지지만 요철·노이즈에 더 예민해집니다.",
            "저속 핸들 떨림이 줄지만 저속 차선 추종도 느려집니다.",
        ),
    },
    "driving": {
        "laneless_mode": {
