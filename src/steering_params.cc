...
bool load_k7_steering_params_json(const std::string &path,
  ...
  try {
    ...
    parse_json_optional_bool(text, "variable_steer_max", &params->variable_steer_max);
    parse_json_optional_bool(text, "variable_steer_delta", &params->variable_steer_delta);
    parse_json_optional_int(text, "steer_max_base", 0, 384, &params->steer_max_base);
    parse_json_optional_int(text, "steer_delta_up_base", 0, 20, &params->steer_delta_up_base);
    parse_json_optional_int(text, "steer_delta_down_base", 0, 30, &params->steer_delta_down_base);
    ...
    parse_json_optional_int(text, "torque_angle_deadzone_raw", 0, 50, &params->torque_angle_deadzone_raw);
    ...
    parse_json_optional_bool(text, "avoid_lkas_fault_beyond", &params->avoid_lkas_fault_beyond);
    ...
    parse_json_optional_bool(text, "ldws_car_fix", &params->ldws_car_fix);
    ...
    parse_json_optional_bool(text, "invert_steer", &params->invert_steer);
