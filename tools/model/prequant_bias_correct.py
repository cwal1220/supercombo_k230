#!/usr/bin/env python3
"""Pre-quantize Conv/Gemm weights on nncase's per-channel uint8 grid and correct biases (v0.9.4 supercombo inputs).
...
INPUTS = ("input_imgs", "big_input_imgs", "desire", "traffic_convention", "nav_features", "features_buffer")
