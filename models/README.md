...
```text
b6462b3374361ed0a0d65127d00da2af48da65b0b02d23ae096ec43d07f34822  supercombo.kmodel
...
```sh
/Users/chan/Documents/openpilot_c2/model_viz_experiment/.venv/bin/python \
  tools/model/rewrite_supercombo_onnx.py \
  --in-model /Users/chan/Documents/openpilot_c2/selfdrive/modeld/models/supercombo.onnx \
  --out-model models/onnx/supercombo_gemm_split3_iddwelu223_nogru_splitplan_delta.onnx \
  --gemm-split \
  --split-plan-output \
...
/Users/chan/Documents/openpilot_c2/model_viz_experiment/.venv/bin/python \
  ...
  --output models/onnx/supercombo_gemm_split3_iddwelu223_nogru_splitplan_delta_nobig_keepinput_foldzero.onnx \
  --mode fold-zero \
  --keep-big-input
```
